...
set :slack_webhook, 'https://hooks.slack.com/services/XXXXXXXXXX/XXXXXXXXXXXXXX/XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX'
...
set :datadog_api_key, 'XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX'
